                    ...
                    <div className="flex flex-col items-center md:flex-row md:justify-center gap-x-5 ">
                      ...
                      <ul className="flex">
                        {datos.tecs.map((tecs) => (
                          <li
                            key={tecs.idTec}
                            className="flex justify-center items-center w-12 h-12 lg:w-8 lg:h-8 lg:text-lg rounded-full mr-1 text-primary bg-secondary dark:bg-primary dark:text-secondary"
                          >
