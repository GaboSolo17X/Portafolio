...
<main className="flex flex-auto flex-col items-center p-2 overflow-auto">
  <div
    className="w-full max-w-full  lg:max-w-[1100px] xl:max-w-[1100px] 3xl:max-w-[1500px] h-full border-4 lg:border-3 border-secondary rounded-2xl dark:border-primary"
  >
    {/* Header */}
    ...
    {/* Contenido principal */}
    <section className=" p-4 md:p-10 md:pt-5 pb-0 h-[calc(100%-85px)] lg:h-[calc(100%-85px)] font-body text-sm text-secondary dark:text-primary overflow-y-auto md:text-xl  lg:text-sm 3xl:text-xl">
